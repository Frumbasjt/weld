...
lazy_static! {
    pub static ref DEFAULT_OPTIMIZATION_PASSES: Vec<Pass> = {
        let m = ["loop-fusion", "unroll-static-loop", "infer-size", "adapt-reorder-filter-projection", "adapt-predicate",
                 "short-circuit-booleans", "adapt-bloomfilter", "predicate", "vectorize", "fix-iterate"];
